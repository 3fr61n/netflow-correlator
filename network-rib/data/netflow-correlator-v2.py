...
network_rib_rest_address = socket.gethostbyname(os.environ['NETWORK_RIB_REST_ADDR'])
network_rib_rest_port = os.environ['NETWORK_RIB_REST_PORT']
network_rib_rest_user = os.environ['NETWORK_RIB_REST_USER']
network_rib_rest_password = os.environ['NETWORK_RIB_REST_PASSWORD']
